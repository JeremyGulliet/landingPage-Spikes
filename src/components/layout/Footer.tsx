...
export default function Footer() {
    return (
      <footer className="flex justify-center items-center w-full xl:w-[1440px] xl:h-[466px] xl:py-[64px] px-5 ">
        <div className="flex w-full xl:w-[1200px] xl:h-[338px] p-6 ">
          <div className="flex flex-col lg:flex-row w-full xl:w-[1152px] xl:h-[290px] gap-6 ">
            <div className="flex flex-col w-full xl:w-[462px] xl:h-[290px] gap-10 ">
              <div className="flex flex-col xl:w-[462px] xl:h-[123px] gap-4">
                <h3 className="text-medium text-2xl leading-7">Contact</h3>
              </div>
              <div className="flex flex-col gap-[6px] text-white">
                <p className="font-light md:text-lg leading-5">
              ...
              <div className="flex flex-col w-[206px] h-[67px] gap-4">
                ...
                <p className="font-light md:text-lg leading-5 text-white">
            ...
            <div className="flex flex-col w-full xl:w-[462px] xl:h-[252px] gap-10 ">
            ...
            <div className="flex lg:justify-end lg:items-end xl:w-[180px] xl:h-[290px] ">
